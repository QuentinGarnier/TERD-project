...
public class GameInterfacePanel extends JPanel {
    ...
    public void displayTopPanel() {
        ...
        topPanel.add(bar);
        createTxtLabel(topPanel, Language.stage() + ": " + WorldMap.stageNum + ((GameWindow.difficulty().equals(GameWindow.Difficulty.ENDLESS)) ? "/∞" : ("/" + GameWindow.difficulty().stagesNumber)), null);
    ...
    private void refreshTopPanel() {
        ...
        ((JLabel)(topPanel.getComponent(1))).setText(Language.stage() + ": " + WorldMap.stageNum + ((GameWindow.difficulty().equals(GameWindow.Difficulty.ENDLESS)) ? "/∞" : ("/" + GameWindow.difficulty().stagesNumber)));
